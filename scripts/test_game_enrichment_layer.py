...
def test_build_enriched_layer_from_eight_report_rows():
    def run(_tmp):
        ...
        assert_true("console_source_url" in headers, "console source exists")
        ...
        assert_equal(by_name["DIGIMON UP"]["summary_sentence_1"], "", "missing summary stays blank")
        assert_equal(by_name["DIGIMON UP"]["summary_sentence_2"], "", "missing second summary stays blank")
